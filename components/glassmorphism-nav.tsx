          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-3 md:px-6 md:py-2">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:block">
                <button
                  className="relative bg-white hover:bg-gray-50 text-black font-medium px-4 py-2 rounded-full flex items-center transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer group"
                  onClick={() => scrollToSection("#contact")}
                >
                  <span className="mr-2 text-sm">Launch Agent</span>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-2xl">
              <div className="flex flex-col space-y-1">
                ...
                <button
                  ...
                  onClick={() => scrollToSection("#contact")}
                >
                  <span className="mr-2">Launch Your Agent</span>
                  <ArrowRight size={16} className="transition-transform duration-300 group-hover:translate-x-1" />
                </button>
              </div>
            </div>
