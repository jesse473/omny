              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  ...
                  <div className="text-center p-3 md:p-4 rounded-lg bg-white/10 border border-white/20">
                    <div className="text-xs md:text-sm text-gray-300 mb-1">With OmnyAgent</div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Additional Engagements</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Engagement Growth</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      <Users className="w-4 h-4 md:w-5 md:h-5 text-gray-300" />
                      <span className="text-sm md:text-base text-white">Customer Satisfaction</span>
                    </div>
                    <span className="text-lg md:text-xl font-bold text-white">+{businessConfig.satisfaction}%</span>
                  </div>
                </div>
                ...
                <div className="mt-6 md:mt-8 p-4 md:p-6 rounded-lg bg-white/5 border border-white/10">
                  <div className="text-center">
                    <div className="text-xs md:text-sm text-gray-300 mb-2">Estimated Monthly Impact</div>
                    <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2">
                      +{(additionalLeads * 12).toLocaleString()} engagements/year
                    </div>
