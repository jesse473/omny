    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in-subheading">
        ...
        <div className="flex flex-col items-center gap-1 sm:hidden">
          <span className="text-base text-slate-300">Irish dealerships lose</span>
          <div className="flex items-center gap-2">
            <span className="text-2xl font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent animate-pulse-glow">
              €200K+
            </span>
            <span className="text-base text-slate-300">annually</span>
          </div>
        </div>
